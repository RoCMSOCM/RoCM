...
\def \Ta {\shortstack{Research \\ Computer Vision \\  Libraries}}
\def \TaAlt {Research Computer Vision Libraries}

\def \Tb {\shortstack{Learn \\ Dependent \\ APIs}}
\def \TbAlt {Learn Dependent APIs}
...
\def \TeAlt {Database Development}

\def \Tf {\shortstack{Software \\ Development}}
\def \TfAlt {Software Development}

\def \Tg {\shortstack{Analysis \\ and \\ Testing}}
\def \TgAlt {Analysis and Testing}
	...
	\begin{tikzpicture}[
	  ...
	  level 1/.style={sibling distance=5em}]
		...
		[edge from parent fork down]
			% Children
			child{node[node_style, xshift=-21ex, yshift=-2ex] {Product Research\\and\\Analysis}
				child[leaftaskshift,second] {node[task_style,xshift=10ex]{\Ta}}
				child[leaftask,second] {node[task_style,xshift=6ex]{\Tb}}}
			child{node[node_style, xshift=-7ex] {Design\\Model}
				child[leaftask,second] {node[task_style,xshift=-3ex,yshift=3ex]{\Tc}}
			...
			child {node[node_style, xshift=7ex] {Application\\Development}
				...
				child[leaftask,second] {node[task_style,xshift=4ex,yshift=-5ex]{\Tf}}}
			child {node[node_style, xshift=21ex]{Evaluate\\Application}
				child[leaftask,second] {node[task_style, xshift=-6ex]{\Tg}}
...
\begin{tikzpicture} [
	...
	\node [task, xshift=-5ex, label={[align=center]\Db/\Y},right=of task1] (task2) {\Tb}; 
