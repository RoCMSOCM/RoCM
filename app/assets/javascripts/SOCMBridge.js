...
function add_table_elements(d) {  
  ...
  d.Functions = "<button class='plot function_button default_button btn-xs' id='" + d.galaxy_name + "-PLOT'' style='font-size: .8em !important;'>"
                + "Plot"
                + "</button>"
                + "<button class='deltav_plot function_button default_button btn-xs' id='DELTAV-PLOT' name='" + d.galaxy_name + "' style='font-size: .8em !important;'>"
                + "ΔV/V Density"
                + "</button>"
                + "<button class='deltav_plot function_button default_button btn-xs' id='DELTAV-DISTRIBUTION-PLOT' name='" + d.galaxy_name + "' style='font-size: .8em !important;'>"
                + "ΔV/V Distribution"
                + "</button>"
